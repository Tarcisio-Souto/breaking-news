<div class="">
    ...
    <div class="p-8 lg:w-1/2 mx-auto">
        ...
        <div class="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
            <p class="text-center text-sm text-gray-500 font-light"> Ou acesse com suas credenciais </p>
            <form class="mt-6" wire:submit="login">
                ...
                <div class="relative mt-3"> <input
                        class="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline"
                        id="password" type="password" wire:model="password" placeholder="" />
                    <div class="absolute left-0 inset-y-0 flex items-center"> <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-7 w-7 ml-3 text-gray-400 p-1" viewBox="0 0 20 20" fill="currentColor">
                            <path
                ...
                <br>
                <div class="mb-3 row">
                    <span wire:loading class="col-md-3 offset-md-5 text-primary">Validando...</span>
                </div>
            </form>
        </div>
    </div>
