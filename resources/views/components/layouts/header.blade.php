<!-- component -->
<nav class="bg-red-500 z-50 fixed w-full top-0 left-0 border border-gray-200 dark:border-gray-700  sm:px-4 py-2.5 rounded dark:bg-gray-800 shadow">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="/" class="flex items-center">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
                <img src="https://png.pngtree.com/png-vector/20221102/ourmid/pngtree-breaking-news-vector-label-png-image_6413040.png" alt="logo" class="h-20 w-79">
            </span>
        </a>
